...
import type { IPoint, RenderTexture } from 'pixi.js';
...
class KawaseBlurFilter extends Filter
{
     ...
     */
    constructor(blur: number | number[] = 4, quality: number = 3)
    {
     ...
     * @private
     */
    apply(filterManager: any, input: RenderTexture, output: RenderTexture, clear: any): void
    {
